...
def analyze_image(img: Image, dict_of_vars: dict):
    ...
    prompt = (
        ...
        f"4. Mathematical formulas or identities with variables like a^2 + b^2, E=mc^2, etc.: In this case, do not solve but return the formula in LaTeX format as [{{'expr': 'formula', 'result': LaTeX representation}}]. "
